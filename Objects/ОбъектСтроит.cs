...
namespace IIS.RS_2
{
    ...
    public class DetailArrayOfОбъектСтроит : ICSSoft.STORMNET.DetailArray
    {
        ...
        //  *** Start programmer edit section *** (IIS.RS_2.DetailArrayOfОбъектСтроит members)

        //  *** End programmer edit section *** (IIS.RS_2.DetailArrayOfОбъектСтроит members)
        ...
        /// </summary>
        public DetailArrayOfОбъектСтроит(IIS.RS_2.РазрешНаСтроит fРазрешНаСтроит) : 
                base(typeof(ОбъектСтроит), ((ICSSoft.STORMNET.DataObject)(fРазрешНаСтроит)))
        {
        }
        
        public IIS.RS_2.ОбъектСтроит this[int index]
        {
            get
            {
                return ((IIS.RS_2.ОбъектСтроит)(this.ItemByIndex(index)));
            }
        }
        
        public virtual void Add(IIS.RS_2.ОбъектСтроит dataobject)
        {
